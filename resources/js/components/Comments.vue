			...
			<h4>Коментарі:</h4>
				<ul class="list-group">
					<li class="list-group-item" v-for="(comment, index) in comments">
						...
						<a href="#" v-on:click.prevent=" showComment(comment.id)">
							<i class="fas fa-highlighter my-font-size my-margin-left"></i>
						</a>
						<a href="#" v-on:click.prevent=" deleteComment(comment.id)">
							<i class="fas fa-times my-font-size my-margin-left"></i>
						</a>
						</span>
					</li>
				</ul>
